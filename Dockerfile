...
ONBUILD RUN export RAILS_ENV=production; ! gem list -i badcom || rake badcom:requirejs:optimize_all

# Precompile assets
ONBUILD RUN export RAILS_ENV=production; rake assets:precompile
